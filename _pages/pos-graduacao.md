...
- **Autonomia.** Eu oriento, mas o trabalho é seu. Espero que você busque soluções, pesquise, erre e tente de novo antes de pedir ajuda — e que peça ajuda quando travar.
- **Comunicação constante.** Combinaremos encontros regulares. Aparecer, mostrar progresso (mesmo pequeno) e relatar dificuldades cedo é fundamental.
- **Inglês para leitura.** Boa parte da literatura relevante está em inglês. Você não precisa ser fluente, mas precisa conseguir ler artigos técnicos.
- **Método.** Trabalhamos com métodos empíricos e Engenharia de Software Baseada em Evidências. Rigor, reprodutibilidade e honestidade nos resultados não são negociáveis.
- **Organização.** Versionar código (Git), registrar decisões e manter um cronograma realista fazem toda a diferença.
...
- Lembre-se: **sou seu orientador, não seu chefe.** Estou aqui para guiar e apoiar; o protagonismo da pesquisa é seu.
